            ...
            <div className={style.bg}>
                <div className="w-full text-white text-center h-20 z-10  relative">
                    ...
                    <div className='m-auto text-center text-white z-10 py-3 relative'>
                        ...
                        <form className='relative z-10 bg-white p-2 rounded-[20px]'>
                            <input placeholder='Nama' className='w-full p-2 rounded-md mt-5 border border-black outline-none' />
                            ...
                            <div className='py-5 h-[22rem] overflow-y-scroll'>
