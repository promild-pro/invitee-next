                ...
                <div className="w-full text-white text-center h-20 z-10  relative">
                    ...
                    <div className='m-auto text-center text-white z-10 py-3 relative'>
                        ...
                        <form className='relative z-10 bg-white p-2 rounded-md'>
                            <input placeholder='Nama' className='w-full p-2 rounded-md border border-black hover:border-black' />
                            <input placeholder='Ucapan Anda' className='w-full pb-10 my-5 rounded-md border border-black' />
