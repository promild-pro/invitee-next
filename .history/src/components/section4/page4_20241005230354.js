        ...
        <section className={style.bg} >
            ...
            <div className='bg-black bg-opacity-25 w-[90%] p-2 my-20 m-auto z-10 relative rounded-3xl'>
                <div className='bg-black bg-opacity-20 border-double border-4  rounded-3xl m-auto'>
                    <div className='w-1/2 m-auto rounded-full my-10 border-4 border-black border-double bg-white my-5'>
                    ...
                    <div className='flex justify-between items-center text-white w-2/5 m-auto'>
                        <div className='border w-10 border-white'/>
                        <h1 className='sacramento font-bold text-7xl'>&</h1>
                        <div className='border w-10 border-white'/>
                    </div>
                    <div className='w-1/2 m-auto rounded-full my-10 border-4 border-black border-double bg-white my-5'>
