...
export default function Page4(){
    return(
        <section className={style.bg} >
            ...
            <div className='bg-black bg-opacity-20 border-double border-4  rounded-xl m-auto'>
                <div className='w-1/2 m-auto rounded-xl border-4 border-black border-double bg-white my-5'>
                    <Image src={ImgMen} alt='img-men' className='h-1/2 overflow-y-hidden' />
                </div>
            </div>
            </div>
        </section>
