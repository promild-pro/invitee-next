...
export default function Page4(){
    return(
        <section className={style.bg} >
            ...
            <div className='bg-black bg-opacity-15 w-3/4 p-2 m-auto z-10 relative rounded-lg'>
            <div className='bg-black bg-opacity-15 border-double border-2  rounded-xl m-auto'>
