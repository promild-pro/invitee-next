                ...
                <div className='bg-black bg-opacity-20 border-double border-4  rounded-3xl m-auto'>
                    ...
                    <div className='text-center text-white  py-5'>
                        ...
                        <div className='w-16 text-white flex justify-around m-auto'>
                            <Link href='' className=' ' >
                                <GrInstagram className=' text-lg border p-1 rounded-md bg-white bg-opacity-15' />
                            </Link>
                            <Link href='' className=' ' >
                                <RiFacebookCircleLine className=' text-lg border p-1 rounded-md bg-white bg-opacity-15 ' />
                            </Link>
                        </div>
