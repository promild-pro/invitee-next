...
export default function Hero() {
    ...
    <section className={`${style.bgSection} h-[100dvh] min-h-[100vh] w-full relative overflow-x-hidden flex justify-center items-center`}>
        ...
        <div className="z-10 text-center bg-white bg-opacity-25 font-sans flex-col items-center w-3/4  py-20 rounded-full border border-white ">
            <p className="tracking-widest pb-5 ">Wedding Invitation</p>
            <h2 className="sacramento text-[3rem] font-bold leading-10 py-10 text-orange-900" style={{textShadow:'2px 2px white'}}>Dilan <br/>&<br/>Milea</h2>
            <p>Kepada Yth.</p>
