                ...
                <div className='text-center text-white w-2/3 m-auto my-10'>
                    ...
                    <div className='w-[90%] m-auto text-white p-2' >
                        <div className="text-blue-700 bg-white rounded-xl ">
                            <div className="flex text-3xl p-5 font-bold italic">
                                <RiBankCardFill />
                                <h3>BCA</h3>
                            </div>
                            <div className="m-auto w-[90%] pb-5">
                                <p>6796586xxxxx a. n. Dilan</p>
                                <button className="flex bg-black p-1 rounded-xl text-white w-full justify-center items-center my-2 m-auto ">
                                    <FaRegCopy />
                                    Salin
                                </button>
                            </div>
