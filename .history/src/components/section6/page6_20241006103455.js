    ...
    return(
        <section className={style.bg}>
            <div className='w-[90%] m-auto bg-black bg-opacity-30 rounded-3xl border-4 border-double  z-10 relative'>
                ...
                <div className='flex justify-center items-center italic text-white text-3xl w-[90%] m-auto'>
                    <p className='w-[33%]'>Minggu</p>
                    <div className='border-x-2 text-center px-4 w-[34%] '>
                        <p>10</p>
                        <p>Okt</p>
                    </div>
                    <p  className='w-[33%]'>2024</p>
                </div>
            </div>
        </section>
    )
