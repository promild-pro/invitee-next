    ...
    return(
        <section className={style.bg}>
            <div className='w-[90%] m-auto bg-black bg-opacity-30 rounded-3xl border-4 border-double  z-10 relative'>
                ...
                <h3 className='text-center font-sans text-white text-2xl  my-10'>AKAD NIKAH</h3>
                <div className='flex justify-center items-center italic text-white text-4xl w-[90%]'>
                    <p>Minggu</p>
                    <div className='border-x-2 text-center px-4 '>
                        <p>10</p>
                        <p>Okt</p>
                    </div>
                    <p>2024</p>
