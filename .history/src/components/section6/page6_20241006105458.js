        ...
        <section className={style.bg}>
            <div className='w-[90%] m-auto bg-black bg-opacity-30 rounded-3xl border-4 border-double  z-10 relative'>
                ...
                <div className='text-center text-white w-2/3 m-auto my-10'>
                    ...
                    <p>Jl. Medokan Asri Utara No.39, Medokan Ayu, Kec. Rungkut, Surabaya, Jawa Timur 60295</p>
                    <Link href='https://maps.app.goo.gl/HTX9SdwgY35qR7ePA' className="bg-black border-white border rounded-lg p-2" >Open Location</Link>
                </div>
            </div>
        </section>
    )
