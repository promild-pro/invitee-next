    ...
    return(
        <section className={style.bg}>
            <div className="absolute bottom-0 flex justify-center w-full items-center">
                <div className="text-white  z-10 justify-center w-3/4 items-center text-center relative ">
                    <p>The Wedding Of</p>
                    ...
                    <button className="bg-white bg-opacity-15 p-2 flex justify-center items-center rounded-lg" >
                      <FaRegCalendarCheck />
                      Save The Date
                    </button>
                </div>
