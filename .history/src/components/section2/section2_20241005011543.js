  ...
  if (completed) {
    ...
    return(
        <section className={style.bg}>
            <div className="absolute bottom-0 flex justify-items-center w-full items-center m-0">
                <div className="text-white  z-10 w-3/4 items-center text-center relative ">
                    <p>The Wedding Of</p>
