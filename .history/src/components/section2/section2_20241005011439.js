...
const renderer = ({days, hours, minutes, seconds, completed }) => {
  if (completed) {
    ...
    // Render a countdown
    return (
        <div style={{  fontSize: '2rem', textAlign: 'center' }} className="flex p-2">
    ...
    return(
        <section className={style.bg}>
            <div className="absolute bottom-0 right-0 flex justify-center w-full items-center m-0">
                <div className="text-white flex-col z-10 w-3/4 items-center text-center relative ">
                    <p>The Wedding Of</p>
